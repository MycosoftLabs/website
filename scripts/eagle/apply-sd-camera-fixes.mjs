...
const ADD = [
  ...
  // Remaining live streams from the SanDiegoWebCam (SunDiegoLive) YouTube channel.
  ytFeature("youtube-oceanside-railroad", "Oceanside, CA Railroad (Transit Center) — Amtrak / Coaster / Sprinter", 33.1959, -117.3795, "fc58f5x18-w", "traffic", "SanDiegoWebCam channel — live view of the Oceanside Transit Center railroad (Pacific Surfliner, COASTER, SPRINTER trains). LIVE on the channel /streams 2026-06-15."),
  ytFeature("youtube-oceanside-rooftop-bar", "Oceanside Rooftop Bar — pier / beach", 33.1925, -117.3850, "cvP_F-c2Upw", "surf", "SanDiegoWebCam channel — Oceanside rooftop view toward the pier and beach. LIVE."),
  ytFeature("youtube-oceanside-rooftop-bar-west", "Oceanside Rooftop Bar (Fixed Wide West)", 33.1929, -117.3858, "OYqo4dqYjh0", "surf", "SanDiegoWebCam channel — Oceanside rooftop fixed wide west view. LIVE."),
  ytFeature("youtube-lake-otay", "Lake Otay (Lower Otay Reservoir) — South County", 32.6250, -116.9400, "zScdt7Z839s", "scenic", "SanDiegoWebCam channel — Lower Otay Lake / reservoir, south San Diego County. LIVE."),
  {
    type: "Feature",
