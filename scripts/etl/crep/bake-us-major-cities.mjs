...
const CATEGORIES = [
  ...
  { id: "govt-embassy",   render: "point",   q: (S,W,N,E) => `[out:json][timeout:90];(node["amenity"="embassy"](${S},${W},${N},${E});way["amenity"="embassy"](${S},${W},${N},${E});node["amenity"="townhall"](${S},${W},${N},${E});way["amenity"="townhall"](${S},${W},${N},${E});node["office"="government"](${S},${W},${N},${E});way["office"="government"](${S},${W},${N},${E});node["amenity"="courthouse"](${S},${W},${N},${E});way["amenity"="courthouse"](${S},${W},${N},${E});node["amenity"="library"](${S},${W},${N},${E});way["amenity"="library"](${S},${W},${N},${E}););out geom center;` },
]
