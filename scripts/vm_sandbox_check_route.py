...
def main() -> None:
    ...
    commands = [
        "cd /opt/mycosoft/website && git rev-parse --short HEAD",
        "ls -la /opt/mycosoft/website/app/api/mindex",
        "find /opt/mycosoft/website/app/api/mindex -maxdepth 2 -type f -name 'route.ts' | sed -n '1,50p'",
    ]
