...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Innovation: Earth Simulator", href: "/apps/earth-simulator", icon: Globe },
      { title: "Innovation: Petri Dish", href: "/apps/petri-dish-sim", icon: PipetteIcon },
      { title: "Innovation: Mushroom Sim", href: "/apps/mushroom-sim", icon: Microscope },
      { title: "Innovation: Compound Sim", href: "/apps/compound-sim", icon: FlaskConical },
      { title: "Innovation: Growth Analytics", href: "/apps/growth-analytics", icon: LineChart },
      { title: "Innovation: Genetic Circuit", href: "/apps/genetic-circuit", icon: Binary },
      { title: "Innovation: Retrosynthesis", href: "/apps/retrosynthesis", icon: Braces },
      { title: "Innovation: Alchemy Lab", href: "/apps/alchemy-lab", icon: FlaskConical },
      { title: "Innovation: Digital Twin", href: "/apps/digital-twin", icon: Boxes },
      { title: "Innovation: Physics Sim", href: "/apps/physics-sim", icon: Cpu },
      { title: "Innovation: Symbiosis", href: "/apps/symbiosis", icon: Layers },
      { title: "Innovation: Spore Tracker", href: "/apps/spore-tracker", icon: Globe },
      { title: "Innovation: Lifecycle Sim", href: "/apps/lifecycle-sim", icon: LineChart },
    ],
  },
  {
    title: "Development",
