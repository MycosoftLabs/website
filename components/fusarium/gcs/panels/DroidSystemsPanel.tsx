 ...
 * buses, and the six edge services. It is the only renderer of the `/api/fusarium/gcs/droid-systems`
 * payload anywhere in the repo.
 *
 * NOT MOUNTED YET (Aug 02 2026). Nothing imports this panel, so `/api/fusarium/gcs/droid-systems` has
...
interface DroidI2cEntry {
  /** `addr` is what /api/fusarium/gcs/droid-systems emits; `address` is the alternate spelling. */
