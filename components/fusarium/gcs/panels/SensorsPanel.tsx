...
import { Panel, SectionLabel, StatLED, type LedColor } from "@/components/fusarium/gcs/ui";
...
function useKind(kind: string) {
  const { data, error } = useSWR<Probe>(`/api/fusarium/gcs/fusion-sensors/${kind}`, probe, {
