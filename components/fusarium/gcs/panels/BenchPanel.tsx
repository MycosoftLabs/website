...
import { type BuoyCommand, type BuoyTelemetry, type ThrusterId } from "@/lib/fusarium/gcs/contract";
import { useThrottledSend } from "@/lib/fusarium/gcs/useThrottledSend";
...
export function BenchPanel({
  ...
  const benchDirect = async (cmd: string, params: Record<string, unknown> = {}) => {
    try {
      const r = await fetch("/api/fusarium/gcs/agent-command", {
        method: "POST",
