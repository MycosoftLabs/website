...
import { emptyCameraRig, type BuoyCommand, type BuoyTelemetry, type CameraFeed, type CameraRig } from "@/lib/fusarium/gcs/contract";
...
export default function CameraView({
  ...
  const devWebcam = useMemo(() => {
    ...
    if (process.env.NEXT_PUBLIC_FUSARIUM_GCS_CAM_DEV === "1") return true;
  ...
  // day/night controls do nothing. TargetView owns IR-cut and posts to /api/fusarium/gcs/camera/ircut.
