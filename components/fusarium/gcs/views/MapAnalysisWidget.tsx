...
import { StatLED } from "@/components/fusarium/gcs/ui";
import type { BuoyTelemetry } from "@/lib/fusarium/gcs/contract";
import { SineWidget } from "./SineWidget";
import { useSineDetections } from "@/lib/fusarium/gcs/useSineDetections";
...
export function MapAnalysisWidget({
  ...
  const focus = selectedName ?? "Global vehicle";
  ...
  return (
    <div className="psa-glass absolute left-3 top-3 z-20 flex max-h-[calc(100%-1.5rem)] w-60 flex-col gap-2 overflow-y-auto overscroll-contain rounded-xl p-2.5">
      ...
      <div>
        ...
        {/* Nothing in the system stores or lists captured frames — app/api/fusarium/gcs/camera/** serves
