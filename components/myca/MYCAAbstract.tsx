...
const FLOW_SECTIONS = [
  ...
  },
  {
    ...
    visual: "Other SI was built for commerce, search, or products. None was built for the biosphere.",
    content: [
      ...
      "Environmental decisions need SI that sees reality, not just web pages.",
    ],
  ...
  },
  {
    ...
    visual: "MYCA is the only SI trained on live biospheric signals and fungal-inspired architecture.",
    content: [
      "Other SI learns from static datasets. MYCA learns continuously from sensors, devices, and real-world data streams.",
