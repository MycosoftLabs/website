  ...
  return (
    <div className={`earth-simulator-container w-full h-screen relative flex ${className}`}>
      ...
      <div className="flex-1 relative">
        ...
        {/* Layer Controls */}
        <div className="absolute top-4 right-4 z-10 mt-16">
          <LayerControls layers={layers} onLayersChange={setLayers} />
        </div>

        {/* Grid Controls */}
        <div className="absolute top-40 right-4 z-10 bg-black/70 rounded-lg p-3 text-white text-sm">
          <div className="font-bold mb-2">24x24 Land Grid</div>
          ...
          <div className="text-xs text-gray-400 mb-2">Tile Size:</div>
          <select 
            value={gridTileSize} 
