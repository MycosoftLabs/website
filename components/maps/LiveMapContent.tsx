...
/**
 * LiveMapContent - Client-only wrapper for deck.gl map components
 * This component handles all deck.gl imports to avoid SSR/build issues
 */
...
import { useDeviceLayers, DEVICE_COLORS } from "./DeviceTrips";
