...
export const MYCOSOFT_PROJECTS: MycosoftProject[] = [
  ...
  },
  {
    ...
    pitch: "MYCOSOFT biz-dev vertical thesis site. Historic Route 66 community, east Mojave desert ecology adjacent to NPS MOJA — Joshua trees, desert tortoise, creosote, bighorn.",
