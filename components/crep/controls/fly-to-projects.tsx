...
export const US_MAJOR_CITIES: MycosoftProject[] = [
  ...
  { id: "fly-menlo",    code: "MPK",  label: "Menlo Park",               pitch: "Sand Hill Road, Stanford corridor, SRI, Bay Area investor demo zone.",    center: [-122.1817, 37.4529], zoom: 12, layersOn: US_METRO_NATURE_LAYERS, accent: "border-orange-500/40 hover:border-orange-400 hover:bg-orange-500/10 text-orange-200" },
  ...
  const chip = (p: MycosoftProject) => (
    <button
      ...
      className={cn(
        ...
        "active:scale-95",
        p.accent,
        compact ? "min-h-[44px] min-w-[44px] px-2 py-1 text-[10px]" : "min-h-[44px] min-w-[44px] px-3 py-1.5 text-[11px]",
      )}
