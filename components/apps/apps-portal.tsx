...
const APPS_PORTAL_HERO_WALK_SOURCES = ["/assets/mushroom1/mushroom 1 walking.mp4"]
const APPS_FEATURED_MYCONODE_DEPLOY_SOURCES = ["/assets/myconode/myconode deploy1.mp4"]
const APPS_INTEGRATION_MYCONODE_MYCELIUM_SOURCES = ["/assets/myconode/myconode mycelium.mp4"]
