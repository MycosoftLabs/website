...
const productTabs = [
  { id: "mushroom1", label: "Mushroom1" },
  { id: "myconode", label: "MycoNode" },
    ...
    <div className="min-h-dvh">
          ...
          >
            ...
            >
              <div className="sticky top-0 bg-background border-b p-6 flex items-center justify-between">
                ...
                <NeuButton variant="default" onClick={() => setSelectedMission(null)} className="p-2">
                  <X className="h-5 w-5" />
                </NeuButton>
              </div>
              ...
              <div className="p-6 space-y-8">
                ...
                <div className="pt-6 border-t flex justify-end gap-4">
                  <NeuButton variant="default" onClick={() => setSelectedMission(null)}>
                    Close
                  </NeuButton>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <NeuCard className="h-full transition-colors">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <NeuButton variant="primary" className="py-4">
                  Download White Paper
                  <FileText className="ml-2 h-5 w-5" />
                </NeuButton>
                <Link href="/defense/oei">
                  <NeuButton variant="default" className="py-4">
                    Learn More
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </NeuButton>
                </Link>
      ...
      <section className="py-24">
        <div className="container max-w-7xl mx-auto px-4">
          ...
          <NeuTabs tabs={productTabs} activeIndex={productTabIndex} onTabChange={setProductTabIndex} className="w-full" ariaLabel="Defense products">

            <NeuTabsContent id="panel-mushroom1" tabId="mushroom1" isActive={productTabIndex === 0}>
            ...
            <NeuTabsContent id="panel-myconode" tabId="myconode" isActive={productTabIndex === 1}>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <div className="space-y-6">
            ...
            <NeuTabsContent id="panel-sporebase" tabId="sporebase" isActive={productTabIndex === 2}>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <div className="space-y-6">
            ...
            <NeuTabsContent id="panel-alarm" tabId="alarm" isActive={productTabIndex === 3}>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <div className="space-y-6">
            ...
            <NeuTabsContent id="panel-natureos" tabId="natureos" isActive={productTabIndex === 4}>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <div className="space-y-6">
      ...
      <section className="py-24">
        <div className="container max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <NeuBadge variant="default" className="mb-4">Operational Vignettes</NeuBadge>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {missionCriticalData.map((useCase, index) => (
              ...
              >
                <NeuCard 
                  className="h-full transition-all cursor-pointer group hover:scale-[1.01]"
                ...
                >
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h3 className="font-semibold group-hover:text-primary transition-colors">{useCase.title}</h3>
                    </div>
                  </div>
                    ...
                    >
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between pt-2 border-t">
                          <NeuBadge variant="default" className="text-xs">
      ...
      <section className="py-24">
        <div className="container max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <NeuBadge variant="default" className="mb-4">Integration</NeuBadge>
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {selectedDodItem.details.compliance.map((standard, i) => (
                            <motion.div
                              ...
                              transition={{ delay: i * 0.05 }}
                            >
                              <NeuBadge variant="default">{standard}</NeuBadge>
                            </motion.div>
                          ))}
                        </div>
                      </div>
