...
export function NlmFormspaceHero({ className }: NlmFormspaceHeroProps) {
  return (
    <div className={cn("w-full", className)}>
      <div className="relative overflow-visible rounded-3xl border border-black/10 bg-white/20 text-black shadow-[0_24px_60px_rgba(15,23,42,0.12),inset_0_1px_0_rgba(255,255,255,0.55)] backdrop-blur-xl dark:border-white/20 dark:bg-black/20 dark:text-white dark:shadow-[0_24px_60px_rgba(0,0,0,0.28),inset_0_1px_0_rgba(255,255,255,0.18)]">
        ...
        <div className="relative z-10 flex flex-col px-3 py-4 sm:px-6 sm:py-6">
          <div className="mb-3 flex items-center justify-center gap-2 sm:gap-3">
            ...
            <h1 className="text-3xl font-bold text-black sm:text-4xl md:text-5xl dark:text-white">Mycosoft</h1>
          </div>
          <p className="text-center text-base text-black sm:text-lg md:text-xl dark:text-white">
            Operational Environmental Superintelligence
          </p>
          <p className="mx-auto mb-4 mt-2 max-w-2xl text-center text-xs italic text-black/60 sm:text-sm dark:text-white/75">
