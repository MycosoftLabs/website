            ...
            >
              ...
              >
                ...
                <PetriGlassButton
                  ...
                  onClick={toggleVoice}
                  active={isListening}
                  disabled={!isListening && !hasWebSpeech && !isConnected && connectionState !== "connecting"}
                ...
                <PetriGlassButton
                  ...
                  onClick={() => {
                    if (typeof window !== "undefined") {
                      window.location.assign("/natureos/earth-simulator")
                    }
                  }}
                ...
                {onOpenMYCADemo ? (
                  <PetriGlassButton
                    ...
                    onClick={() => onOpenMYCADemo()}
                    onPointerDown={() => onOpenMYCADemo()}
