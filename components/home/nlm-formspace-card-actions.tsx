  ...
  return (
    <>
      <div className="relative mt-auto grid w-full grid-cols-3 gap-2 px-3 pb-4 sm:px-4">
        <Link
          href={paperHref}
          className="inline-flex min-h-[44px] min-w-0 flex-col items-center justify-center gap-0.5 overflow-hidden rounded-xl border border-black/15 bg-white/70 px-1 text-[11px] leading-none text-slate-950 shadow-[inset_0_1px_0_rgba(255,255,255,0.9)] backdrop-blur-md transition-transform duration-300 hover:scale-[0.975] dark:border-white/30 dark:bg-white/10 dark:text-white dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.35)]"
        >
      ...
      <Dialog open={videoOpen} onOpenChange={setVideoOpen}>
        <DialogContent className="w-[calc(100%-1.5rem)] max-w-4xl border-black/10 bg-white/80 p-3 text-slate-950 backdrop-blur-xl sm:p-4 dark:border-white/25 dark:bg-black/45 dark:text-white">
