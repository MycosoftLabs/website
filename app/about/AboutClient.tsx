...
const technologies = [
  ...
  },
  {
    ...
    description:
      "In laboratory environments, our technology aims to automate and smartly monitor the growth and health of fungi in Petri dishes and farm environments. By incorporating data-gathering sensors and superintelligence-powered tools, we aim to improve precision and efficiency in scientific research and commercial farming.",
    image:
