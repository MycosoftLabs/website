...
export const metadata: Metadata = {
  title: "Defense Technical Docs | Mycosoft",
  description: "Technical documentation for defense intelligence systems and integrations.",
}

export default function DefenseTechnicalDocsPage() {
  return (
    <main className="min-h-dvh bg-background">
      <section className="container mx-auto px-4 py-10 md:py-14">
        ...
        <p className="mt-4 text-xs sm:text-sm text-muted-foreground uppercase tracking-wide">
          Defense Technical Docs
        </p>
        <h1 className="mt-2 text-3xl sm:text-4xl md:text-5xl font-semibold">
          Integration Documentation
        </h1>
        <p className="mt-4 text-base sm:text-lg text-muted-foreground">
          Reference architecture, API specifications, and deployment guides for defense-grade
          integrations with MAS, CREP, and device telemetry services.
        </p>
      </section>
      ...
      <section className="container mx-auto px-4 pb-12">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-lg border p-4">
            <h2 className="text-lg font-semibold">API references</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Documented endpoints for security, telemetry, and alerting services.
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <h2 className="text-lg font-semibold">Deployment guides</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Steps for VM deployments, container rebuilds, and integrity checks.
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <h2 className="text-lg font-semibold">Compliance notes</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Security requirements, audit trails, and data handling policies.
            </p>
          </div>
        </div>
      </section>
