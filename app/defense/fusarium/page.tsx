...
export const metadata: Metadata = {
  title: "FUSARIUM | Mycosoft Defense",
  description: "FUSARIUM unifies CREP streams, edge sensors, and AI inference for defense-grade awareness.",
}
  ...
  return (
    <main className="min-h-dvh bg-background">
      <section className="container mx-auto px-4 py-10 md:py-14">
        ...
        <p className="mt-4 text-xs sm:text-sm text-muted-foreground uppercase tracking-wide">FUSARIUM</p>
        <h1 className="mt-2 text-3xl sm:text-4xl md:text-5xl font-semibold">FUSARIUM Platform</h1>
        <p className="mt-4 text-base sm:text-lg text-muted-foreground">
          FUSARIUM connects live environmental telemetry with predictive inference to create
          a unified operational picture for defense and resilience teams.
        </p>
      </section>
      ...
      <section className="container mx-auto px-4 pb-12">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-lg border p-4">
            <h2 className="text-lg font-semibold">Unified sensor mesh</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Aggregates CREP feeds, device telemetry, and partner data streams.
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <h2 className="text-lg font-semibold">Inference pipelines</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              AI models classify anomalies, correlate signals, and surface actionable insights.
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <h2 className="text-lg font-semibold">Command integration</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Supports alerting, workflow automation, and multi-agency coordination.
            </p>
          </div>
        </div>
      </section>
