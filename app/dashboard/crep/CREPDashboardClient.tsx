...
export default function CREPDashboardPage() {
  ...
  const [layers, setLayers] = useState<LayerConfig[]>([
    ...
    { id: "biodiversity", name: "Biodiversity Hotspots", category: "environment", icon: <Sparkles className="w-3 h-3" />, enabled: false, opacity: 0.7, color: "#a855f7", description: "High biodiversity concentration areas. OFF by default — paginated iNaturalist fetch returns up to 20k observations per viewport which piles on top of infra layers." },
