...
/**
 * NatureOS app chrome (sidebar + top nav).
 * Exact `/natureos` is the public marketing page — no dashboard shell.
 */
export default function NatureOSLayoutClient({
  ...
  const isMarketingLanding = pathname === "/natureos" || pathname === "/natureos/"
  ...
  return (
    ...
    <div className="natureos-glass-page min-h-dvh flex flex-col text-slate-950 dark:text-white">
      <TopNav />
      {/*
      ...
      */}
      <SidebarProvider defaultOpen={false}>
        ...
        <div className="flex flex-1 h-[calc(100dvh-3rem)] md:h-[calc(100dvh-3.5rem)] transition-all duration-300">
          ...
          <Sidebar className="natureos-sidebar-shell border-r border-white/30 bg-white/50 backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.04]">
          ...
          <div className="flex-1 overflow-hidden transition-all duration-300 w-full min-w-0">
            ...
            <div className="hidden sm:flex lg:hidden items-center gap-2 px-3 py-1.5 border-b border-white/25 bg-white/50 backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.04]">
              <SidebarTrigger
