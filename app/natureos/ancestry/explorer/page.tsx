      ...
      <div className="bg-gradient-to-br from-green-900 via-green-800 to-emerald-900 text-white">
        <div className="container mx-auto px-4 py-12">
          <div className="flex items-center gap-2 text-sm text-green-200 mb-4">
            <Link href="/natureos/ancestry" className="hover:text-white transition-colors">
              Ancestry
            </Link>
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            ...
            <div className="flex flex-wrap gap-3">
              <Button variant="secondary" asChild>
                <Link href="/natureos/ancestry/phylogeny">
              ...
              {searchQuery.trim() ? (
                <>
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-3 mt-2">
                    <Button
                      onClick={() => router.push(`/natureos/ancestry/species/name/${encodeURIComponent(searchQuery.trim())}`)}
                    >
          ...
          <Card className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950 dark:to-emerald-950 border-green-200 dark:border-green-800">
            ...
            <CardContent>
              ...
              <Button variant="outline" asChild className="w-full border-green-300 dark:border-green-700">
                <Link href="/natureos/ancestry/phylogeny">Explore Trees</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950 dark:to-cyan-950 border-blue-200 dark:border-blue-800">
            ...
            <CardContent>
              ...
              <Button variant="outline" asChild className="w-full border-blue-300 dark:border-blue-700">
                <Link href="/natureos/ancestry/database">View Database</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950 dark:to-pink-950 border-purple-200 dark:border-purple-800">
            ...
            <CardContent>
              ...
              <Button variant="outline" asChild className="w-full border-purple-300 dark:border-purple-700">
                <Link href="/natureos/ancestry/tools">Open Tools</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
