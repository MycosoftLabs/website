...
export default function NatureOSInsightsPage() {
  return (
    <DevicePageShell
      ...
      text="Fleet health, role distribution, aggregated BME688 + SporeBase trends, and SI-summarized anomalies across the Mycosoft device network and 2026 deployment sites."
    >
