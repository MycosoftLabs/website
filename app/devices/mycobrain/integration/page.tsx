    ...
    <div className="container py-8">
      <div className="mb-8">
        ...
        <p className="text-xl text-muted-foreground">
          MycoBrain V1 is a dual├óΓé¼ΓÇÿESP32├óΓé¼ΓÇÿS3 board (Side├óΓé¼ΓÇÿA sensors, Side├óΓé¼ΓÇÿB routing) with SX1262 LoRa. Telemetry and commands
      ...
      <Tabs defaultValue="overview" className="space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                <li><strong>Side├óΓé¼ΓÇÿA</strong>: sensors, I├é┬▓C scan, analog inputs, MOSFET control.</li>
                <li><strong>Side├óΓé¼ΓÇÿB</strong>: UART├óΓÇáΓÇ¥LoRa routing, ACK + retry command channel.</li>
                <li><strong>Telemetry</strong>: best├óΓé¼ΓÇÿeffort. <strong>Commands</strong>: reliable.</li>
              </ul>
        ...
        <TabsContent value="mindex" className="space-y-6">
          <Card>
            ...
            <CardContent className="text-muted-foreground">
              Define a MycoBrain device schema in MINDEX. Ingest Side├óΓé¼ΓÇÿB telemetry via MAS (decode COBS, verify CRC16), map
        ...
        <TabsContent value="natureos" className="space-y-6">
          <Card>
            ...
            <CardContent className="text-muted-foreground">
              ...
              control actions (toggle MOSFET, set telemetry period, trigger I├é┬▓C scan) using the reliable command channel.
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="mas" className="space-y-6">
          <Card>
            ...
            <CardContent className="text-muted-foreground">
              MAS agents maintain device connections (LoRa/UART), implement ACK + retry, and expose a high├óΓé¼ΓÇÿlevel API.
