...
export default function SignUpPage() {
  ...
  // Support redirect and redirectTo (same as login) so /signup?redirect=/agent works
  const redirectTo =
        ...
        <Card className="w-full max-w-lg">
          ...
          <CardContent>
            <Button asChild className="w-full">
              <Link href={redirectTo !== "/" ? `/login?redirectTo=${encodeURIComponent(redirectTo)}` : "/login"}>Go to sign in</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
    ...
    <div className="container flex min-h-dvh w-screen flex-col items-center justify-center py-8">
      <Card className="w-full max-w-lg">
        <CardHeader className="space-y-1">
          ...
          <CardDescription>Enter your information to get started with Mycosoft</CardDescription>
        </CardHeader>
        <CardContent>
          {/* OAuth Buttons */}
