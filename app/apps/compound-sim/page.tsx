...
export const metadata: Metadata = {
  title: "Compound Simulator | Apps",
  description: "Compound analysis and simulation for fungal and chemical intelligence.",
}
    ...
    <main className="min-h-dvh bg-background">
      <section className="container mx-auto px-4 py-10 md:py-14">
        ...
        <p className="mt-4 text-base sm:text-lg text-muted-foreground">
          Analyze chemical profiles, compound interactions, and downstream biological impacts.
        </p>
      </section>
      ...
      <section className="container mx-auto px-4 pb-12">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-lg border p-4">
            <h2 className="text-lg font-semibold">Compound analysis</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Model compound structures and binding characteristics.
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <h2 className="text-lg font-semibold">Simulation workflows</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Run scenario-based simulations with configurable parameters.
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <h2 className="text-lg font-semibold">Data provenance</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Connect to MINDEX compound data and lab results for validation.
            </p>
          </div>
        </div>
      </section>
