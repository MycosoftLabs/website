...
export const metadata: Metadata = { title: "Protected Data Fabric | Fusarium" }
export default function Page() { return <PlatformOperationWorkspace definition={platformOperation("storage")} /> }
