...
export const metadata: Metadata = { title: "Compute Fabric | Fusarium" }
export default function Page() { return <PlatformOperationWorkspace definition={platformOperation("containers")} /> }
