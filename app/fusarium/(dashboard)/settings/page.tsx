...
export const metadata: Metadata = { title: "Settings | Fusarium" }
export default function Page() { return <PlatformOperationWorkspace definition={platformOperation("settings")} /> }
