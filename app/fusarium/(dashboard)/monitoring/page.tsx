...
export const metadata: Metadata = { title: "Mission Assurance | Fusarium" }
export default function Page() { return <PlatformOperationWorkspace definition={platformOperation("monitoring")} /> }
