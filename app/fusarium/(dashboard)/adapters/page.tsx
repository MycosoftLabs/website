...
export const metadata: Metadata = { title: "Adapters | Fusarium" }
export default function Page() { return <PlatformOperationWorkspace definition={platformOperation("adapters")} /> }
