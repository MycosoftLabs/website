  ...
  return (
    <LegalDraft
      ...
      sections={[
        ...
        ["How data is used", "Operating the workspace, computing customer-requested score estimates, generating customer-requested drafts, billing, support, and security. Tenant data is not used to train SI models absent a separate, explicit opt-in."],
        ["Processors", "Supabase (database and authentication), Stripe (payments), model providers for customer-initiated SI actions under the prompt-firewall policy, and infrastructure providers — each listed with purpose in the final notice."],
