...
export default function AupPage() {
  return (
    <LegalDraft
      ...
      sections={[
        ["Truthful use", "Customers may not upload fabricated evidence, backdate records, misstate training or implementation, or direct SI to create false certifications, customers, revenue, test results, or qualifications."],
        ...
        ["SI usage", "SI drafts require human review before use. Customers may not present SI drafts as certified or independently assessed work product."],
