  ...
  return (
    <LegalDraft
      ...
      sections={[
        ...
        ["Payments, renewal, cancellation, refunds", "Prices per the published catalog. Recurring plans renew only as explicitly selected; failed payment leads to a defined grace and read/export period, not immediate data loss. Founding Pass terms as published."],
