  ...
  return (
    <LegalDraft
      ...
      sections={[
        ...
        ["SI limitations and required review", "SI outputs are drafts requiring customer review. No SI output marks a requirement implemented, affirms compliance, or makes representations on the customer's behalf."],
