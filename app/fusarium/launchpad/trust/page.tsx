...
const enforcement = [
  ...
  ["Prompt firewall", "Restricted fields are stripped before any SI call, and outputs are filtered so no SI response can assert certification or mark a control implemented."],
  ["Per-object sensitivity labels", "Every stored object carries a classification and sensitivity label controlling SI use, export, and sharing."],
