    ...
    if (!masData?.response_text) {
      masData = {
        response_text: dataCards.length > 0
          ...
          : `I'm MYCA, Mycosoft's SI assistant. I'm reconnecting to my intelligence services. Please try your question again in a moment.`,
      }
    }
