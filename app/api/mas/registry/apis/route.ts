...
/**
 * Proxy to MAS registry APIs list.
 * GET /api/mas/registry/apis - used by Activity topology for live API catalog.
 */
...
export async function GET(request: NextRequest) {
  try {
    const url = new URL("/api/registry/apis", MAS_API_URL)
