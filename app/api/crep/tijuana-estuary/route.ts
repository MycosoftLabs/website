...
const TJ_OYSTER_CAMERAS = [
  ...
  { id: "cam-windy-sanysidro-border", name: "Windy — Tijuana / San Ysidro border crossing", lat: 32.5435, lng: -117.0298, category: "camera", provider: "windy", has_stream: true, description: "Live border-crossing camera surfaced by Windy / VI Ads / AllTrafficCams.", stream_url: "https://webcams.windy.com/webcams/stream/1748557784" },
...
const TJ_OYSTER_GOVERNMENT = [
  { id: "gov-cbp-sanysidro",    name: "San Ysidro Point of Entry",                       lat: 32.5427, lng: -117.0295, category: "government", agency: "CBP",   description: "CBP San Ysidro land border crossing with live passenger, pedestrian, SENTRI, ready-lane, PedWest, and Cross Border Xpress wait times.", metadata: { port_code: "2504", cbp_port_numbers: ["250401", "250409", "250407"], border_wait_times: true, wait_times_route: "/api/crep/border-wait-times?port=san-ysidro", official_source: "https://bwt.cbp.gov/api/waittimes" } },
