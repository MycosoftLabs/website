...
const TJ_OYSTER_CAMERAS = [
  { id: "cam-ib-pier-surfline", name: "Surfline — Imperial Beach Pier",       lat: 32.5789, lng: -117.1342, category: "camera", provider: "surfline",   description: "Live surf cam at IB pier, waves + shore.", stream_url: "https://www.surfline.com/surf-report/imperial-beach/5842041f4e65fad6a7708bff" },
  { id: "cam-cbp-sanysidro",    name: "CBP — San Ysidro POE",                  lat: 32.5427, lng: -117.0295, category: "camera", provider: "cbp",        description: "US Customs + Border Protection POE live feed (border wait times).", stream_url: "https://bwt.cbp.gov" },
  { id: "cam-cbp-otaymesa",     name: "CBP — Otay Mesa POE",                   lat: 32.5492, lng: -116.9695, category: "camera", provider: "cbp",        description: "Otay Mesa commercial POE border cam.", stream_url: "https://bwt.cbp.gov" },
  { id: "cam-caltrans-i5-s5",   name: "Caltrans I-5 S of Coronado Bridge",     lat: 32.6800, lng: -117.1580, category: "camera", provider: "caltrans",   description: "CCTV on I-5 approach to Coronado Bridge.", stream_url: "https://cwwp2.dot.ca.gov/data/d11/cctv/" },
  { id: "cam-caltrans-sr75",    name: "Caltrans SR-75 Silver Strand",          lat: 32.6600, lng: -117.1500, category: "camera", provider: "caltrans",   description: "CCTV on Silver Strand Highway, Naval Amphibious Base.", stream_url: "https://cwwp2.dot.ca.gov/data/d11/cctv/" },
  { id: "cam-caltrans-i5-s14",  name: "Caltrans I-5 @ Main St (Chula Vista)",  lat: 32.6300, lng: -117.0850, category: "camera", provider: "caltrans",   description: "CCTV on I-5 Chula Vista corridor.", stream_url: "https://cwwp2.dot.ca.gov/data/d11/cctv/" },
  { id: "cam-earthcam-ib",      name: "EarthCam — Imperial Beach Boardwalk",   lat: 32.5785, lng: -117.1341, category: "camera", provider: "earthcam",   description: "Live shore cam from IB pier area.", stream_url: "https://www.earthcam.com/usa/california/imperialbeach/" },
  { id: "cam-noaa-coronado",    name: "NOAA Coronado buoy cam",                 lat: 32.6670, lng: -117.2630, category: "camera", provider: "noaa",       description: "NOAA station 46232 ocean + sky cam off Point Loma.", stream_url: "https://www.ndbc.noaa.gov/station_page.php?station=46232" },
  { id: "cam-windy-sd-skyline", name: "Windy — Downtown SD skyline",           lat: 32.7157, lng: -117.1611, category: "camera", provider: "windy",      description: "Live SD skyline cam.", stream_url: "https://windy.com/webcams" },
  { id: "cam-surfline-corr",    name: "Surfline — Coronado Central",            lat: 32.6859, lng: -117.1831, category: "camera", provider: "surfline",   description: "Coronado central beach live surf cam.", stream_url: "https://www.surfline.com" },
  { id: "cam-surfline-sunsetcliffs", name: "Surfline — Sunset Cliffs",         lat: 32.7200, lng: -117.2550, category: "camera", provider: "surfline",   description: "Sunset Cliffs live cam, Point Loma.", stream_url: "https://www.surfline.com" },
  { id: "cam-windy-silverstrand",name: "Windy — Silver Strand State Beach",    lat: 32.6470, lng: -117.1370, category: "camera", provider: "windy",      description: "Silver Strand beach cam.", stream_url: "https://windy.com/webcams" },
]
