...
export const metadata: Metadata = {
  title: "Profile | Mycosoft",
  description: "User profile for Mycosoft services, devices, and workflows.",
}
  ...
  return (
    <main className="min-h-dvh bg-background">
      <section className="container mx-auto px-4 py-10 md:py-14">
        ...
        <p className="mt-4 text-xs sm:text-sm text-muted-foreground uppercase tracking-wide">Profile</p>
        <h1 className="mt-2 text-3xl sm:text-4xl md:text-5xl font-semibold">User Profile</h1>
        <p className="mt-4 text-base sm:text-lg text-muted-foreground">
          Manage identity, access preferences, and linked systems across the Mycosoft platform.
        </p>
      </section>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-lg border p-4">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Update contact information, roles, and authentication settings.
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <h2 className="text-lg font-semibold">Program access</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              View your access to devices, data programs, and operational dashboards.
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <h2 className="text-lg font-semibold">Activity history</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Review recent actions, alerts, and workflow participation.
            </p>
          </div>
        </div>
      </section>
