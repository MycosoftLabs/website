...
const sections = [
  {
    ...
    "paragraphs": [
      ...
      "MYCA is being built for that missing layer. It is an environmental intelligence system designed to connect super intelligence to live signals from the world: biological, chemical, acoustic, thermal, mechanical, spatial, and ecological. Instead of treating nature as a backdrop for human activity, MYCA treats the living world as an active source of data, feedback, and intelligence. It is not simply another chatbot, dashboard, or automation layer. It is a step toward SI that can perceive, reason, coordinate, and act in relationship with real environments.",
      "The technical difference is fundamental. Conventional SI systems usually begin with text, images, documents, code, or user prompts. MYCA begins with state: what is happening, where it is happening, when it is happening, how confident the system is, what evidence exists, and what consequences may follow. Its architecture is designed around sensor fusion, grounded memory, environmental telemetry, and agentic coordination. Language is still important, but language becomes the explanation layer, not the only source of truth.",
      "The philosophical difference is just as important. MYCA is built from the belief that intelligence should not be defined only by how well a system talks. A truly useful intelligence should be able to listen to reality. It should be able to notice change, preserve context, respect uncertainty, and help humans understand systems too complex for any one person or institution to monitor alone. Where many SI products compete to become more convincing conversational partners, MYCA is being built to become a more faithful interpreter of the living world.",
      "The business reason is clear: the next frontier of SI value will not come only from better office automation. It will come from connecting SI to the physical systems that drive food, water, health, infrastructure, climate resilience, field operations, and scientific discovery. Organizations need more than reports; they need situational awareness. They need systems that can detect change earlier, understand context better, and coordinate action faster. MYCA is built for that market.",
      "The risk is that this is harder than building software that only reads screens and databases. Physical signals are noisy. Biological systems are variable. Sensor deployments must survive real environments. Data must be trusted before it can be acted on. That difficulty is exactly why the reward is meaningful. A company that can solve grounded environmental intelligence does not merely build another SI feature. It creates a new category: intelligence connected to the planet itself."
    ]
  },
  {
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "The business advantage is that hardware anchors the platform in reality. Software-only SI is easier to copy. A field-ready system that combines devices, edge intelligence, data provenance, biological signal processing, and operational software is much harder to replicate. Hardware also opens multiple revenue channels: device sales, subscriptions, consumables, maintenance, analytics, enterprise deployments, research collaborations, and specialized applications.",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "Compared to conventional SI systems, this makes MYCA more suitable for serious operational settings. Many SI products rely heavily on user judgment after the answer appears. MYCA is being designed so that uncertainty, provenance, permission, and review are part of the architecture before the answer appears. That is a major difference for customers who need defensible decisions.",
      ...
      "The business advantage is trust and market access. Regulated customers, scientific organizations, enterprise buyers, and public-sector partners are more likely to adopt SI systems that can demonstrate auditability, explainability, and responsible constraints. The risk is that governance can slow down experimentation. The reward is that it enables adoption in higher-value markets where trust is not optional."
    ]
  },
  {
    ...
    "paragraphs": [
      "MYCA's business advantage comes from convergence. It is not just an SI model, not just a sensor device, not just a dashboard, not just a scientific database, and not just a workflow automation tool. It is the combination of those layers into a single environmental intelligence architecture. That convergence is difficult, but it is also the source of the moat.",
      "The first advantage is data originality. Generic SI systems compete over similar model capabilities and similar public information. MYCA's value grows through original environmental and biological data streams, especially where devices capture signals that are not widely available elsewhere. This creates a path toward proprietary datasets, specialized models, and differentiated insights.",
      "The second advantage is vertical integration. By building across hardware, edge intelligence, biological interfaces, software, data, and orchestration, Mycosoft can design the whole loop rather than waiting for disconnected tools to fit together. This reduces dependency on any one external platform and allows the company to optimize the product around real environmental intelligence instead of generic SI workflows.",
      "The third advantage is category creation. Customers already understand parts of the problem: environmental monitoring, lab automation, compliance logging, sensor networks, SI assistants, data dashboards, and field devices. MYCA unifies those categories under a stronger thesis: the world needs SI that can learn from reality. That is a story investors, customers, researchers, and partners can understand.",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "Few companies are positioned to build this because the work requires unusual overlap. It requires comfort with fungi and sensors, with field hardware and SI models, with scientific uncertainty and product urgency, with ecological philosophy and business execution. Many SI companies start from software and look outward. Mycosoft starts from the living world and builds intelligence around it.",
      "That is the core differentiation. MYCA is not trying to win by sounding more human than other systems. It is trying to win by being more grounded, more embodied, more environmentally aware, and more useful in the real world. The highest-value SI of the future will not only answer questions about reality. It will help us perceive reality as it changes."
    ]
  },
  {
    "id": "vision",
    ...
    "paragraphs": [
      ...
      "The vision is not technology dominating nature. It is technology learning from nature. It is a future where SI becomes less isolated from the world and more accountable to it. It is a future where biological systems are not treated as passive resources, but as partners in understanding the planet.",
    ...
    <DocsLayout>
      <article className="max-w-3xl text-foreground [&_h1]:text-4xl [&_h1]:font-bold [&_h1]:mb-6 [&_h1]:scroll-mt-24 [&_h2]:mt-14 [&_h2]:pt-6 [&_h2]:mb-4 [&_h2]:border-t [&_h2]:border-border [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:scroll-mt-24 [&_h3]:mt-10 [&_h3]:mb-3 [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:scroll-mt-24 [&_p]:my-4 [&_p]:leading-relaxed [&_ul]:my-4 [&_ul]:pl-6 [&_ul]:list-disc [&_ul]:space-y-2 [&_ol]:my-4 [&_ol]:pl-6 [&_ol]:list-decimal [&_ol]:space-y-2 [&_li]:leading-relaxed [&_a]:text-primary [&_a]:underline [&_a]:underline-offset-2 hover:[&_a]:text-primary/80 [&_strong]:font-semibold [&_strong]:text-foreground [&_em]:italic [&_code]:px-1 [&_code]:py-0.5 [&_code]:rounded [&_code]:bg-muted [&_code]:text-sm [&_hr]:my-12 [&_hr]:border-border">
        ...
        <p className="text-sm text-muted-foreground">
          Previous: <Link href="/docs/ai">SI Stack</Link> ? Next:{" "}
