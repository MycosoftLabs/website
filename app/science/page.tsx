...
export const metadata: Metadata = {
  title: "Science | Mycosoft",
  description: "Scientific research, experiments, and analysis across the Mycosoft platform.",
}
  ...
  return (
    <main className="min-h-dvh bg-background">
      <section className="container mx-auto px-4 py-10 md:py-14">
        <p className="text-xs sm:text-sm text-muted-foreground uppercase tracking-wide">Science</p>
        <h1 className="mt-2 text-3xl sm:text-4xl md:text-5xl font-semibold">Scientific Research</h1>
        <p className="mt-4 text-base sm:text-lg text-muted-foreground">
          Coordinate experiments, simulations, and lab intelligence with MAS and MINDEX data.
        </p>
      </section>
      ...
      <section className="container mx-auto px-4 pb-12">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-lg border p-4">
            <h2 className="text-lg font-semibold">Lab operations</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Track instruments, experiments, and telemetry for active research.
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <h2 className="text-lg font-semibold">Simulation pipelines</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Configure models and workloads for predictive analysis.
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <h2 className="text-lg font-semibold">Scientific intelligence</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Leverage MINDEX data for hypothesis development and evaluation.
            </p>
          </div>
        </div>
      </section>
