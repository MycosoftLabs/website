# Mycosoft ITDX26 Algorithm Lab v1.3

**Start with [README_V13.md](README_V13.md)** for the new source workspace, fictional replay, source-pack installation and Fusarium handoff. The original prototype instructions and historical release notes below still apply to those earlier modules.
