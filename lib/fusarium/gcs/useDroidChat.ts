 ...
 * /api/fusarium/gcs/droid-chat returned text the agent actually produced. Every other outcome — a
...
/** Per-droid chat + MAS oversight relay. See app/api/fusarium/gcs/droid-chat/route.ts. */
const CHAT_ENDPOINT = "/api/fusarium/gcs/droid-chat";
/** Existing owner-gated probe of the OpenClaw bridge — reused rather than duplicated. */
const HEALTH_ENDPOINT = "/api/fusarium/gcs/openclaw/status";
