  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      },
      {
        title: "Psathyrella",
        description:
          "In development — partial build live; documentation forthcoming.",
      ...
      },
      {
        ...
        href: "/docs/devices/fci",
        status: "frontier",
        sources: placeholderSources("devices-fci"),
      },
      {
        title: "FCI Firmware",
        description:
          "The firmware that bridges FCI hardware to MYCA workloads — the piece we are actively making work alongside FCI to enable fungal compute.",
