...
export const WORKBOOK_STEPS: WorkbookStep[] = [
  ...
  { id: 'asa-controls', module: 'ASA Workspace', title: 'Mark the 110-requirement register', summary: 'Customer or Local Agent only — SI cannot mark implemented.', href: '/app/launchpad/readiness/controls', bff: 'GET/PATCH /readiness/controls' },
  ...
  { id: 'ai', module: 'SI connections', title: 'Connect BYO keys (envelope) or use managed credits', summary: 'BYO on every tier including Launch Pass. BYO = 0 credits.', href: '/app/launchpad/settings/keys', bff: 'GET/POST /ai/connections' },
