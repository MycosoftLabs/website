...
SANDBOX_ENV_ALLOWLIST = [
    ...
    "NEXT_PUBLIC_HOME_HERO_YOUTUBE_ID",
    "NEXT_PUBLIC_HYPHAE1_HERO_YOUTUBE_ID",
    "NEXT_PUBLIC_SPOREBASE_HERO_YOUTUBE_ID",
    "NEXT_PUBLIC_ABOUT_HERO_YOUTUBE_ID",
    "NEXT_PUBLIC_DEVICES_HERO_YOUTUBE_ID",
    "NEXT_PUBLIC_HOME_HERO_POSTER",
