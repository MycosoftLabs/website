...
Generated: 2026-05-27T08:24:25.051Z
...
- MEDIUM: Slow integration probes exceed public MYCA target 6 probes took longer than 3000 ms.
...
| --- | --- | --- | --- | --- | ---: | ---: | --- |
| website | website-health | GET | /api/health | loopback | 200 | 5026ms | yes |
| crep | crep-health | GET | /api/crep/health | loopback | 200 | 2259ms | yes |
| myca | myca-connectivity | GET | /api/myca/connectivity | loopback | 200 | 3240ms | yes |
| myca | myca-live-activity | GET | /api/myca/live-activity | loopback | 200 | 7584ms | yes |
| myca | myca-orchestrator-get | GET | /api/mas/voice/orchestrator | loopback | 200 | 51ms | yes |
| myca | myca-chat-smoke | POST | /api/mas/voice/orchestrator | loopback | 200 | 2860ms | yes |
| mas | website-mas-health-proxy | GET | /api/mas/health | loopback | 200 | 3380ms | yes |
| mindex | website-mindex-health-proxy | GET | /api/mindex/health | loopback | 200 | 1028ms | yes |
| mindex | natureos-mindex-health | GET | /api/natureos/mindex/health | loopback | 200 | 4010ms | yes |
| crep | crep-fungal-san-diego | GET | /api/crep/fungal?north=33.20&south=32.45&east=-116.70&west=-117.35&limit=200 | loopback | 200 | 16430ms | yes |
| mas | direct-mas-health | GET | /health | private-lan | 200 | 2134ms | yes |
| mas | direct-mas-myca-ping | GET | /api/myca/ping | private-lan | 200 | 2077ms | yes |
