...
Generated: 2026-05-27T06:28:11.627Z
...
- MEDIUM: Slow integration probes exceed public MYCA target 2 probes took longer than 3000 ms.
...
| --- | --- | --- | --- | --- | ---: | ---: | --- |
| website | website-health | GET | /api/health | loopback | 200 | 2245ms | yes |
| crep | crep-health | GET | /api/crep/health | loopback | 200 | 62ms | yes |
| myca | myca-connectivity | GET | /api/myca/connectivity | loopback | 200 | 2208ms | yes |
| myca | myca-live-activity | GET | /api/myca/live-activity | loopback | 200 | 6549ms | yes |
| myca | myca-orchestrator-get | GET | /api/mas/voice/orchestrator | loopback | 200 | 46ms | yes |
| myca | myca-chat-smoke | POST | /api/mas/voice/orchestrator | loopback | 200 | 2860ms | yes |
| mas | website-mas-health-proxy | GET | /api/mas/health | loopback | 200 | 1172ms | yes |
| mindex | website-mindex-health-proxy | GET | /api/mindex/health | loopback | 200 | 2099ms | yes |
| mindex | natureos-mindex-health | GET | /api/natureos/mindex/health | loopback | 200 | 2265ms | yes |
| crep | crep-fungal-san-diego | GET | /api/crep/fungal?north=33.20&south=32.45&east=-116.70&west=-117.35&limit=200 | loopback | 200 | 26217ms | yes |
| mas | direct-mas-health | GET | /health | private-lan | 200 | 114ms | yes |
| mas | direct-mas-myca-ping | GET | /api/myca/ping | private-lan | 200 | 4ms | yes |
| mindex | direct-mindex-root-health | GET | /health | private-lan | 200 | 8ms | yes |
| mindex | direct-mindex-health | GET | /api/mindex/health | private-lan | 200 | 1017ms | yes |
| mindex | direct-mindex-health-all | GET | /api/mindex/health/all | private-lan | 200 | 16ms | yes |
| supabase | supabase-rest-root | GET | /rest/v1/ | public-supabase | 401 | 59ms | yes |
